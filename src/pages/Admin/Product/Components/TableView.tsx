              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3 w-16">
                    <div className="w-12 h-12 rounded-lg overflow-hidden bg-slate-100 dark:bg-slate-800 border border-slate-100 dark:border-slate-850">
                      <img
                  ...
                  <td className="px-4 py-3 w-[80px]">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-slate-455 dark:text-slate-500">Units</span>
                    </div>
                  </td>
                  ...
                  <td className="px-4 py-3 w-[100px]">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs text-slate-455 dark:text-slate-550">({product.rating.count})</span>
                    </div>
                  </td>
        ...
        {products.map((product) => (
          <div key={product._id} className="bg-white dark:bg-slate-900/60 p-4 border border-slate-200 dark:border-slate-800 rounded-xl space-y-4 shadow-none">
            <div className="flex gap-3">
              <div className="w-20 h-20 rounded-lg overflow-hidden bg-slate-100 dark:bg-slate-850 border border-slate-100 dark:border-slate-800 shrink-0">
                <img
                  src={product.images[0]?.url || "https://placehold.co/400x400?text=No+Image"}
            ...
            <div className="grid grid-cols-2 gap-3 py-3 border-y border-slate-100 dark:border-slate-800/80">
              ...
              <div>
                ...
                <div className="flex items-center gap-1 mt-0.5">
                  ...
                  <span className="text-[10px] text-slate-450">({product.rating.count})</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div>
                <p className="text-[10px] text-slate-450 dark:text-slate-550 uppercase font-semibold tracking-wider mb-1.5">Landing Template</p>
                <TemplatePopover
                  currentTemplate={product.additionalInfo?.landingPageTemplate || "template1"}
                  onSelect={(val) => handleTemplateChange(product._id, val)}
                  disabled={updatingId === product._id}
